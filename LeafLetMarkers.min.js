      ...
      if (request.readyState === 4) {
        if ((request.status < 400 && options.local) || request.status === 200) {
         ...
         //   console.log(request.responseText);
			 ...
			 response = parser.parseFromString(request.responseText,"text/xml");
...
define('LeafLetMarkers',['leaflet','leaflet-providers','leaflet-ajax'], function (L) {
	 ...
	 return function (instanceData) {	
	  ...
	  attribution: 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>'
                ...
                map.setView([+instanceData.lat, +instanceData.lon ], +"15");
                var addDataToMap = function addDataToMap(data) {

					 polygonGroup = new L.FeatureGroup();       
					 var runLayer = omnivore.kml.parse(data)
					.addTo(map);   
					
					var arrBounds = [];
					arrBounds.push(runLayer.getBounds().getNorthEast());
					arrBounds.push(runLayer.getBounds().getNorthWest());
					arrBounds.push(runLayer.getBounds().getSouthWest());
					arrBounds.push(runLayer.getBounds().getSouthEast());
					var bounds = L.latLngBounds(arrBounds);
					map.fitBounds(bounds);
					 console.log(bounds);
					 //map.panTo(runLayer.getBounds().getNorthEast());
						//console.log(runLayer.);
						///console.log();
						
						//bounds = L.latLngBounds(, runLayer.getBounds().getNorthEast());
